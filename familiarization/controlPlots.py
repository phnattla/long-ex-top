...
# Open the file
fiData = TFile.Open("root:///eos/user/c/cmsdas/2023/long-ex-top/MuonEG_2016Hv2.root", "READ")
# Get the tree
...
# Open the file
fiMC = TFile.Open("root:///eos/user/c/cmsdas/2023/long-ex-top/TTJets.root", "READ")
# Get the tree
